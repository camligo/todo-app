...
public class CategoryEndToEndTest {
  ...
  public void getAllCategories() {
    given()
      ...
      .body("$", hasSize(2))
      .body("name", hasItems("Home", "Personal"))
  ...
  public void createCategory_success() {
    ...
    given()
      ...
      .statusCode(HttpStatus.OK.value())
      .body("$", hasSize(3))
      .body("name", hasItems("Home", "Personal", "Work"));
  }
  ...
  public void createCategory_existingCategory_failure() {
    ...
    given()
      ...
      .body(matchesJsonSchemaInClasspath("io/nology/todo/category/schemas/existing-category-error-schema.json"))
      .body("errors[0]", equalTo("Category 'Home' already exists"));
  }
